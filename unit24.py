#BÀI 24 : CODE RÚT GỌN LẠI CHƯƠNG TRÌNH ĐẦU TIÊN VỚI HÀM 
...
def cohoackhong(firstname, prompt):
	while True: 
		...
		if gender_input.lower() in answer_yes : 
			return True #Không cần break nữa vì return là kết thúc cả chương trình rồi
...
def main():
	...
	is_vietnamese = cohoackhong(firstname,"Bạn có phải người Việt không (có/không): ") #Một hàm có thể call nhiều lần và được gán nhiều giá trị
	...
	if is_vietnamese: #Để không như này , code sẽ tự hiểu là luôn đúng
		print(firstname + " Là người Việt Nam number one")
	else: #Còn đây là trường hợp ngược lại với đúng là sai ( False )
